...
useEffect(() => {
  ...
  return (
    <div className='main-container'>
            ...
            <section ref={heroRef} className="about-page w-full relative py-5 max-md:mt-25 px-5">
              ...
              <div className="Stats px-4">
                ...
                <div className="top grid grid-cols-2 sm:flex sm:justify-center sm:items-center gap-7">
                  <div className="box flex bg-white/10 backdrop:blur-lg flex-col justify-center items-center gap-2 white-border rounded-xl w-full sm:w-[220px] px-7 py-4">
                  ...
                  <div className="box bg-white/10 backdrop:blur-lg  flex flex-col justify-center items-center gap-2 white-border rounded-xl w-full sm:w-[220px] px-7 py-4">
                    <h1 className="text-center">
                ...
                <div className="bottom grid grid-cols-2 sm:flex sm:justify-center items-center gap-6 mt-10">
                  ...
                  <div className="box bg-white/10 backdrop:blur-lg  flex flex-col justify-center items-center gap-2 white-border rounded-xl w-full sm:w-[220px] px-7 py-4">
                    <h1 className="text-center">
                      ...
                      <span className="text-xl sm:text-2xl md:text-3xl whitespace-nowrap text-white">Client <br className='md:hidden' /> Retention <br /> RATE</span>
                    </h1>
                  </div>
                  <div className="box bg-white/10 backdrop:blur-lg  flex flex-col justify-center items-center gap-2 white-border rounded-xl w-full sm:w-[220px] px-7 py-4">
                    <h1 className="text-center">
      ...
      <div className="max-w-md min-h-52 text-white p-6 rounded-xl shadow-lg white-border bg-white/10 backdrop:blur-lg ">
        {/* Icon + Heading */}
        ...
        <p className="text-gray-300 text-sm leading-relaxed font-sans">
          No matter the time, no matter the need — our dedicated services are always here for you. We dont just meet your requirements, we redefine them. With passion, precision, and a promise of excellence.
            ...
            <section ref={workRef} className='w-full flex-col flex justify-center items-center gap-3 mt-30'>
                ...
                <div>
                     <div className="flex justify-center items-center flex-wrap mt-5 p-4 gap-5">
  <div className="max-w-md max-md:w-full bg-white/10 backdrop:blur-lg  min-h-22 text-white p-6 rounded-xl shadow-lg white-border">
    {/* Icon + Heading */}
    <div className="flex items-center gap-3 mb-4">
    ...
    <p className="text-gray-300 text-sm leading-relaxed font-sans">
      Street 278, Phnom Penh, Cambodia
            ...
            <section ref={consultRef} className='w-full flex-col flex justify-center items-center gap-3 mt-30'>
                ...
                <div>
                     <div className="flex justify-center items-center  flex-wrap mt-5 p-4 gap-5">
      <div className="max-w-80 min-h-46 text-white p-6 rounded-xl shadow-lg white-border bg-white/10 backdrop:blur-lg ">
        {/* Icon + Heading */}
        <div className="flex items-center gap-3 mb-4">
 ...
 <div className="flex justify-center items-center  flex-wrap mt-5 p-4 gap-5">
  ...
  <div className="flex flex-col md:flex-row items-center gap-6 white-border bg-white/10 backdrop:blur-lg  rounded-xl shadow-lg p-6 max-w-5xl w-full">
