...
setsendloading(false)
  ...
  return (
    <div>
      <div className="fixed bottom-5 right-5 z-50 w-96 bg-[#2020209a] backdrop-blur-md rounded-2xl p-5 shadow-lg border border-white/30">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          ...
          <button type="submit" className="mt-4 flex justify-center items-center col-span-2 w-full white-border text-white py-2 rounded-lg hover:bg-white/50 transition">
