...
>
        <SwiperSlide>
  <div className="h-[900px] m  mt-12  lg:h-[650px] py-5 w-[99%] border-[1px] overflow-visible border-white bg-white/10 backdrop:blur-lg  rounded-3xl flex items-center justify-center relative pb-20">
  ...
  <div className="h-auto mt-12  w-full flex items-center justify-center ">
    <div className="h-[900px] lg:h-[650px] w-[99%] border  border-white bg-white/10 backdrop:blur-lg  rounded-3xl flex flex-col lg:flex-row  items-center justify-center relative p-6 lg:p-12">
...
>
  <Image
    ...
    height={200}
    alt="Power Logo"
    className="absolute -top-6 lg:-top-10 
       drop-shadow-[0_10px_20px_rgba(0,0,0,0.25)]"
  />
  <p className="text-white text-lg sm:text-xl lg:text-2xl mt-8">Power Apps</p>
</div>
            ...
            <div className="relative">
              <div className="w-44 sm:w-52 h-24 white-border rounded-md flex flex-col items-center justify-center relative shadow-[0_15px_35px_rgba(0,0,0,0.2),0_5px_10px_rgba(0,0,0,0.1)]">
                <Image
                  ...
                  height={100}
                  alt="Power Logo"
                  className="absolute -top-4 lg:-top-6 w-[60px]   "
                />
            ...
            <div className="relative">
              <div className="w-44 sm:w-52 h-24 white-border rounded-md shadow-[0_15px_35px_rgba(0,0,0,0.2),0_5px_10px_rgba(0,0,0,0.1)] flex flex-col items-center justify-center relative">
                <Image
                  ...
                  height={140}
                  alt="Power Logo"
                  className="absolute -top-4 lg:-top-6 w-[110px] "
                />
                <p className="text-white text-lg sm:text-xl lg:text-2xl mt-10">Power Automate</p>
              </div>
            </div>
          </div>
        </div>
...
{/* third slide  */}
        <SwiperSlide>
  <div className="h-auto mt-12  w-full flex items-center justify-center ">
    <div className="h-[900px] lg:h-[650px] w-[99%] border border-white rounded-3xl bg-white/10 backdrop:blur-lg flex flex-col lg:flex-row items-center justify-center relative p-6 lg:p-12">
