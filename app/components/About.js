...
useEffect(() => {
  ...
  className="desc text-white 
             ...
             text-[17px] font-sans leading-relaxed 
             px-4 sm:px-6 md:px-8
             max-md:max-w-md max-md:text-justify"
>
  We specialize in delivering complete end-to-end hybrid app development — 
  from idea to execution. Our team covers everything: coding, UI/UX design, 
  requirement analysis, testing, deployment, and ongoing maintenance. 
  We’re committed to building powerful, scalable, and high-performing 
  digital solutions tailored to your business needs.
        ...
        <div className="Stats px-4">
          ...
          <div className="top grid grid-cols-2 sm:flex sm:justify-center sm:items-center gap-7">
            <div className="box flex flex-col justify-center items-center gap-2 bg-white/10 backdrop:blur-lg  white-border rounded-xl w-full sm:w-[220px] px-7 py-4">
