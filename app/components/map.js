...
export default function MyMap() {
 useEffect(() => {
  ...
  <h2 className="text-3xl lg:text-5xl text-white md:text-start">
    Find Us on the Map
  </h2>
  ...
  <div className="mt-6 w-full inline-block px-6 py-6 bg-white/10 backdrop-blur-md rounded-2xl text-left shadow-lg">
    ...
    {/* Opening Hours */}
    <h3 className="text-lg font-semibold text-white font-sans mt-4 flex items-center gap-2">
      🕒 Opening Hours
    </h3>
    <p className="text-sm text-white/80 mt-2 font-sans">
  ...
  <div className="w-[60%] h-[500px] rounded-2xl overflow-hidden shadow-lg">
    <MapContainer
      ...
      zoom={13}
      zoomControl={false} // ❌ Zoom buttons hat gaye
      attributionControl={false} // ❌ Attribution patti hat gayi
      style={{
        height: "100%",
        width: "100%",
        borderRadius: "20px",
    ...
    >
      ...
      {/* Heading */}
      <h1 className="map-heading text-5xl pt-9 main-container text-white max-md:text-center">
        Know More About Us
      </h1>
