            ...
            {projectloading ? (
              ...
              projects.projects?.map((project) => (
                <SwiperSlide key={project._id}>
                  <div className="h-auto w-full flex items-center justify-center">
                    <div className="h-auto lg:h-[530px] w-full white-border bg-white/10 backdrop:blur-lg rounded-3xl overflow-hidden flex flex-col lg:flex-row items-center justify-center relative p-6 lg:p-12">
                      <div className="main w-full h-full flex flex-col lg:flex-row justify-center items-center gap-8">
                        ...
                        <div className="left w-full lg:w-1/2 h-full flex flex-col justify-center items-start text-center lg:text-left">
                          ...
                          <p className="text-sm sm:text-base md:text-lg max-md:text-justify font-sans text-white max-w-2xl mb-6 leading-relaxed">
