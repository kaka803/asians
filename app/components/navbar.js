...
export default function Navbar() {
 ...
 useEffect(() => {
  ...
  return (
    <div
  className={`fixed top-0 left-0 w-full z-800 transition-all duration-500
    ${scrolled 
...
>
    ...
    >
      <div className="main-container  flex justify-between items-center gap-5 py-2 px-6">
        ...
        <div className="navlinks hidden lg:block">
          <ul className="flex justify-center items-center gap-10 text-white text-xl font-medium">
  {links.map((link) => (
    <li
      key={link.href}
  ...
  className="button-nav flex justify-center items-center gap-2 border bg-white/10 backdrop:blur-lg border-white/80 rounded-lg px-3 py-1 hover:bg-white hover:text-black transition-all duration-300 hover:scale-105"
>
...
>
  ...
  <Image src="/arrow.svg" width={12} height={12} alt="arrow" />
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden z-900  fixed top-0 h-full w-3/4 sm:w-1/2  bg-white/10 backdrop-blur-xl rounded-l-2xl shadow-2xl p-8 transform transition-all duration-500 ease-in-out
  ...
  className="flex justify-center items-center gap-2 bg-white/10 backdrop:blur-lg border border-white/80 rounded-lg px-4 py-2 text-white hover:bg-white hover:text-black transition-all duration-300 hover:scale-105"
>
  <Image src="/mail.svg" width={20} height={20} alt="mail" />
  Email Us
</a>
...
<a
  ...
  target="_blank" 
  rel="noopener noreferrer"
  className="flex group justify-center items-center gap-2 bg-white/10 backdrop:blur-lg border border-white/80 rounded-lg px-4 py-2 text-white hover:bg-white hover:text-black transition-all duration-300 hover:scale-105"
>
  Contact Us
  <Image src="/arrow.svg" width={12} height={12} alt="arrow" />
</a>
