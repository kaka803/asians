    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            We build modern web apps using Angular, React, Vue, and 
            <br className='hidden md:block' /> 
            MERN Stack with Microsoft expertise.
          </p>
          
          {/* Services */}
         <div className="mx-auto p-4 py-6 rounded-lg white-border">
  <div className="w-[70vw] services-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-6 text-start">
    
    {/* Column 1 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">HTML5</p>
      <p className="text-xl md:text-2xl text-white">CSS3</p>
      <p className="text-xl md:text-2xl text-white">JavaScript</p>
      <p className="text-xl md:text-2xl text-white">TypeScript</p>
    </div>
    
    {/* Column 2 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">React JS</p>
      <p className="text-xl md:text-2xl text-white">Next JS</p>
      <p className="text-xl md:text-2xl text-white">Vue JS</p>
      <p className="text-xl md:text-2xl text-white">Nuxt JS</p>
    </div>
    
    {/* Column 3 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Angular</p>
      <p className="text-xl md:text-2xl text-white">Svelte</p>
      <p className="text-xl md:text-2xl text-white">Tailwind CSS</p>
      <p className="text-xl md:text-2xl text-white">Bootstrap</p>
    </div>

    {/* Column 4 (optional if chahte ho zyada ho) */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Material UI</p>
      <p className="text-xl md:text-2xl text-white">Chakra UI</p>
      <p className="text-xl md:text-2xl text-white">jQuery</p>
      <p className="text-xl md:text-2xl text-white">MERN Stack</p>
    </div>
