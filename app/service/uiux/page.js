...
const Page = () => {
    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            Creative UI/UX, web, app, logo, and branding designs tailored to elevate 
  ...
  <div className="px-20 services-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-6 text-start">
    ...
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Web Design </p>
      <p className="text-xl md:text-2xl text-white">Mobile App Design</p>
    </div>
    
    {/* Column 2 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Logo Design</p>
      <p className="text-xl md:text-2xl text-white">graphic designing</p>
    </div>
    
    {/* Column 3 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Social Media Branding</p>
    </div>
