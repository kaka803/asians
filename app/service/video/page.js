...
const Page = () => {
    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            Professional video editing with effects, audio tweaks, graphics, and 
            <br className='hidden md:block' /> 
            optimized formats for impactful visual content.
          </p>
  ...
  <div className="px-20 services-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-6 text-start">
    ...
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Basic Video Editing</p>
      <p className="text-xl md:text-2xl text-white">Audio Editing</p>
    </div>
    
    {/* Column 2 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Visual Enhancements</p>
      <p className="text-xl md:text-2xl text-white">Format Optimization</p>
    </div>
    
    {/* Column 3 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Advanced/Custom Services</p>
      <p className="text-xl md:text-2xl text-white">Graphics & Visual Effects</p>
    </div>
