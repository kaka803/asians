    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            Empowering businesses with AI-driven innovation, automation, and insights. 
            <br className='hidden md:block' />
            Smarter decisions, scalable solutions, and future-ready technologies.
          </p>
          
          <div className="w-[70%] mx-auto p-4 py-6 rounded-lg backdrop-blur-md white-border shadow-lg">
            <div className="services-grid grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-6 text-start">

              {/* Column 1 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">AI Strategy & Consulting</p>
                <p className="text-xl md:text-2xl text-white">Custom AI Model Development</p>
                <p className="text-xl md:text-2xl text-white">Natural Language Processing (NLP)</p>
              </div>

              {/* Column 2 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Computer Vision Solutions</p>
                <p className="text-xl md:text-2xl text-white">Predictive Analytics & Insights</p>
                <p className="text-xl md:text-2xl text-white">AI-Powered Automation</p>
              </div>
