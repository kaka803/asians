    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            Expert in custom software, enterprise solutions, consulting, and 
            <br className='hidden md:block' /> 
            outsourcing delivering smart, scalable digital products.
          </p>
          ...
          <div className="w-[70%] mx-auto p-4 py-6 rounded-lg backdrop-blur-md white-border shadow-lg">
            <div className="services-grid grid grid-cols-1 sm:grid-cols-2  gap-x-6 gap-y-6 text-start">
              ...
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Software Development</p>
                <p className="text-xl md:text-2xl text-white">Software Consulting</p>
                <p className="text-xl md:text-2xl text-white">Custom Software Development</p>
              </div>
              
              {/* Column 2 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Software Outsourcing</p>
                <p className="text-xl md:text-2xl text-white">Enterprise Software Solution</p>
                <p className="text-xl md:text-2xl text-white">Software Product Development</p>
              </div>
