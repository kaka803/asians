...
const Page = () => {
    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            Expert SEO agency driving growth through local, SaaS, B2B, technical, and 
  ...
  <div className="px-20 services-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-6 text-start">
    
    {/* Column 1 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Local Seo</p>
      <p className="text-xl md:text-2xl text-white">Legal Seo</p>
      <p className="text-xl md:text-2xl text-white">B2B Seo</p>
      <p className="text-xl md:text-2xl text-white">Ecommerce Seo</p>
    </div>
    
    {/* Column 2 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">SaaS Seo</p>
      <p className="text-xl md:text-2xl text-white">Video Seo</p>
      <p className="text-xl md:text-2xl text-white">On-page Seo</p>
      <p className="text-xl md:text-2xl text-white">Services-Based Seo </p>
    </div>
    
    {/* Column 3 */}
    <div className="space-y-2">
      <p className="text-xl md:text-2xl text-white">Off-pafe Seo</p>
      <p className="text-xl md:text-2xl text-white">Technical Seo</p>
      <p className="text-xl md:text-2xl text-white">International Seo </p>
      <p className="text-xl md:text-2xl text-white">Multi-Location Local Seo </p>
    </div>
