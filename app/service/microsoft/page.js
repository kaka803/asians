    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            ...
            Azure, SharePoint, BI, Automate, and more.
          </p>
          ...
          <div className="w-[70%] mx-auto p-4 py-6 rounded-lg backdrop-blur-md white-border shadow-lg">
            <div className="services-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6 text-start">
              ...
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Power Apps</p>
                <p className="text-xl md:text-2xl text-white">SharePoint</p>
                <p className="text-xl md:text-2xl text-white">Power Automate</p>
              </div>
              
              {/* Column 2 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Power BI</p>
                <p className="text-xl md:text-2xl text-white">Azure</p>
                <p className="text-xl md:text-2xl text-white">Power Pages</p>
              </div>
              
              {/* Column 3 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Power Virtual Agents</p>
                <p className="text-xl md:text-2xl text-white">Microsoft Consulting Services</p>
              </div>
            </div>
          </div>
