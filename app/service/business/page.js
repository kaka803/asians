    ...
    <div className='main-container '>
      <div className="flex flex-col justify-center items-center gap-5 mt-30">
          ...
          <p className='sub-heading text-white font-sans mb-3 text-md text-center'>
            Empowering businesses with Microsoft tools like Power Apps, 
            <br className='hidden md:block' /> 
            through integrated, intelligent, and scalable cloud solutions.
          </p>
          
          {/* Services */}
          <div className="w-[70%] mx-auto p-4 py-6 rounded-lg backdrop-blur-md white-border shadow-lg">
            <div className="services-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6 text-start">
              
              {/* Column 1 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Business Central</p>
                <p className="text-xl md:text-2xl text-white">CRM</p>
                <p className="text-xl md:text-2xl text-white">Customer Service</p>
              </div>
              
              {/* Column 2 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">SALES</p>
                <p className="text-xl md:text-2xl text-white">Field Service</p>
                <p className="text-xl md:text-2xl text-white">Project Operations</p>
              </div>
              
              {/* Column 3 */}
              <div className="space-y-2">
                <p className="text-xl md:text-2xl text-white">Microsoft Dynamics 365</p>
                <p className="text-xl md:text-2xl text-white">MS Dynamics NAV</p>
              </div>
            </div>
          </div>
